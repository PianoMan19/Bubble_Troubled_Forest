...
/*let ballRadius = 30;
let x = [canvas.width / 3,canvas.width / 2,canvas.width / 4];
let y = [canvas.height/5,canvas.height/4,canvas.height/3];*/
...
document.getElementById("ball0").addEventListener("load",loadon3,false);
...
let ballsX=[canvas.width / 6-150,canvas.width / 3,canvas.width / 2+150];
let ballsY=[canvas.height/7,canvas.height/5,canvas.height/3];
let ballsRadius=[50,40,30];
let balls = 3;
